...
try:
    ...
    print("⚠️ transformers non installé. Installez avec: pip install transformers")
    HF_AVAILABLE = False
...
def load_model_and_tokenizer():
    ...
    with load_lock:
        ...
        print(f"🔤 Chargement du tokenizer HF: {tokenizer_name}")
...
def generate_response(prompt, max_new_tokens=40, temperature=0.9, top_k=0, top_p=0.9, repetition_penalty=1.3):
    ...
    # Décoder le texte généré avec le tokenizer HF
